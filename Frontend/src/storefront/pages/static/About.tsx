    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-8">About {storeSettings.store_name}</h1>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-slate-700 p-8 mb-8">
            {storeSettings.about_us_picture ? (
              <img 
                ...
                alt={`About ${storeSettings.store_name}`}
            ...
            <div className="prose max-w-none">
              ...
              <p className="text-gray-600 dark:text-slate-300 mb-6">
                {storeSettings.store_name} is your premier destination for the latest electronics and technology products. 
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Why Choose {storeSettings.store_name}?</h2>
