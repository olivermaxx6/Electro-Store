        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-8 transition-colors duration-300">
            <div className="prose max-w-none">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">Personal Information Sources</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4 transition-colors duration-300">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">How We Use Your Personal Information</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4 transition-colors duration-300">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">How We Disclose Personal Information</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4 transition-colors duration-300">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">Relationship with Shopify</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-6 transition-colors duration-300">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">Third Party Websites and Links</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-6 transition-colors duration-300">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">Children's Data</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-6 transition-colors duration-300">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">Security and Retention of Your Information</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4 transition-colors duration-300">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">Your Rights and Choices</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4 transition-colors duration-300">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">Complaints</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-6 transition-colors duration-300">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">International Transfers</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4 transition-colors duration-300">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">Changes to This Privacy Policy</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-6 transition-colors duration-300">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">Contact</h2>
              <p className="text-gray-600 dark:text-gray-300 transition-colors duration-300">
                Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at sppix.ltd@gmail.com or contact us at 99 Blackwell Road, ENG, CV6 5JU, GB. For the purpose of applicable data protection laws, we are the data controller of your personal information.
              </p>
            </div>
          </div>
        </div>
